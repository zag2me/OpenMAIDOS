...
function EditForm($plugin){	
	...
	printTextBox("Author Web Site","plugin_Site", $plugin->plugin_Site);
	printTextBox("Direct Download Link","plugin_DirectDownloadURL", $plugin->plugin_DirectDownloadURL);
	printTextBox("Forum Link","plugin_SupportLink", $plugin->plugin_SupportLink);
...
else slowdie( "Sorry, you are not authorized to edit this addon2.");
