...
SearchBar("","",TRUE);
echo "</div><tr><td id=\"contentarea\"><div id=\"widebar\">";
global $db_host;
global $db_user;
global $db_pass;
global $db_database;
...
if ($res) {
	if ($Author) {
	  echo "<p>&nbsp; </p>";
		echo "<h1 id=title align='center'>Plugins by " . $_GET["author"] . " </h1><br>";
		$c=@mysql_num_rows($res);
		echo "<hr/>"; }
	if ($ProfileID) {
	  echo "<p>&nbsp; </p>";
		echo "<h1 id=title align='center'>Plugins by " . $_GET["profile_id"] . " </h1><br>";
		$c=@mysql_num_rows($res);
		echo "<hr/>"; }
	$enregNb = 0;
...
////////////////////////////////////////////////////////////
    ...
    //icon
		echo "<table border=0 align='center' cellpadding=0 cellspacing=0 width=760";
		echo "><tr><td id=\"pluginicon\" align='center' valign='center' width=200>\n";
		...
		echo "<img src='" . GetPluginIcon($plugin_id,$plugin_version) . "' width='150' height='150'>\n"; //width=100 height=100
    echo "<a href=\"dl.php?plugin_id=$plugin_id\">Download</a> - <a href='detail.php?plugin_id=$plugin_id$breadcrumb'>Full Details</a>"; 
		echo "</a>";
    ...
    //info
		...
		echo "</td><td id=\"plugininfos\">";
		echo "<img src=images/info.png width=22 height=22>  <a href='detail.php?plugin_id=$plugin_id$breadcrumb'><font size=+2>$plugin_name</font></a> v$plugin_version ($plugin_state)";
		...
		echo "<b>Plugin date:</b> $plugin_Date <br />";
 		echo "<b>Description:</b> $plugin_ShortDesc<br /><br />";
